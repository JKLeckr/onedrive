...
_onedrive()
{
	...
	argopts='--create-directory --data-timeout --get-O365-drive-id --remove-directory --single-directory --source-directory'
	...
	--get-file-link)
		...
		return 0
		;;
	--create-directory|--data-timeout|--get-O365-drive-id|--remove-directory|--single-directory|--source-directory)
		return 0
		;;
	*)
